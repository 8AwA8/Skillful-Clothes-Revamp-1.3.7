...
namespace SkillfulClothes.Patches
{
	...
	{
		// Token: 0x06000401 RID: 1025 RVA: 0x00012A68 File Offset: 0x00010C68
		...
		// Token: 0x06000402 RID: 1026 RVA: 0x00012ACC File Offset: 0x00010CCC
		private static bool FindItem(Item item)
		{
			...
			foreach (KeyValuePair<Vector2, StardewValley.Object> keyValuePair in Game1.player.currentLocation.objects.Pairs)
			{
				Vector2 vector;
			...
			{
				foreach (KeyValuePair<Vector2, StardewValley.Object> keyValuePair2 in Game1.getLocationFromName(Game1.player.homeLocation.Value).objects.Pairs)
				{
					Vector2 vector2;
			...
			if (farm != null)
			{
				foreach (KeyValuePair<Vector2, StardewValley.Object> keyValuePair3 in farm.objects.Pairs)
				{
					Vector2 vector3;
					StardewValley.Object object3;
		...
		// Token: 0x06000403 RID: 1027 RVA: 0x00013818 File Offset: 0x00011A18
		...
		// Token: 0x06000404 RID: 1028 RVA: 0x000138A8 File Offset: 0x00011AA8
		...
		// Token: 0x06000405 RID: 1029 RVA: 0x00013918 File Offset: 0x00011B18
		...
		// Token: 0x06000406 RID: 1030 RVA: 0x00013980 File Offset: 0x00011B80
		...
		// Token: 0x06000408 RID: 1032 RVA: 0x00013AD8 File Offset: 0x00011CD8
		...
		// Token: 0x06000409 RID: 1033 RVA: 0x00013B6C File Offset: 0x00011D6C
		...
		// Token: 0x0600040A RID: 1034 RVA: 0x00013BC0 File Offset: 0x00011DC0
		...
		// Token: 0x0600040B RID: 1035 RVA: 0x00013C18 File Offset: 0x00011E18
		...
		// Token: 0x0600040C RID: 1036 RVA: 0x00013D08 File Offset: 0x00011F08
		private static void UpdateTicking(object sender, ButtonPressedEventArgs e)
		{
			if (Context.IsPlayerFree && EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().KeysForWardrobeOpening.IsDown())
			{
				Game1.activeClickableMenu = new WardrobePage(WardrobeCheck.savedClothingSets, WardrobeCheck.savedClothingSetNames);
			}
			...
			if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().KeyForWardrobeSetOne.IsDown())
			{
				if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().ToggleForWardrobeSetReplace.IsDown())
				{
			...
			else if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().KeyForWardrobeSetTwo.IsDown())
			{
				if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().ToggleForWardrobeSetReplace.IsDown())
				{
			...
			else if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().KeyForWardrobeSetThree.IsDown())
			{
				if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().ToggleForWardrobeSetReplace.IsDown())
				{
			...
			else if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().KeyForWardrobeSetFour.IsDown())
			{
				if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().ToggleForWardrobeSetReplace.IsDown())
				{
			...
			else if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().KeyForWardrobeSetFive.IsDown())
			{
				if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().ToggleForWardrobeSetReplace.IsDown())
				{
			...
			else if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().KeyForWardrobeSetSix.IsDown())
			{
				if (EffectHelper.ModHelper.ReadConfig<SkillfulClothesConfig>().ToggleForWardrobeSetReplace.IsDown())
				{
			...
			else if (EffectHelper.ModHelper.Input.IsDown(SButton.MouseLeft) || EffectHelper.ModHelper.Input.IsDown(SButton.ControllerA))
			{
