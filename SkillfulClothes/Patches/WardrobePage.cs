...
namespace SkillfulClothes.Patches
{
	...
	{
		// Token: 0x0600040D RID: 1037 RVA: 0x0001470C File Offset: 0x0001290C
		public override void draw(SpriteBatch b)
		{
			...
			for (int j = 0; j < this.count; j++)
			{
				...
				this.names.TryGetValue(j + 1, out s);
				SpriteText.drawStringWithScrollCenteredAt(b, s, this.xPositionOnScreen + 40 + this.width / 5, this.yPositionOnScreen + 23 + ((j == 0) ? 7 : 0) + this.height / this.count * j, "", 1f, null, 0, 0.88f, false);
				...
				{
					list[0].drawInMenu(b, new Vector2((float)(this.xPositionOnScreen + 9 + (int)((float)this.width * 3.5f / 8f)), (float)(this.yPositionOnScreen + 29 + this.height / this.count * j)), 0.9f, 1f, 5f, StackDrawType.Hide, Color.White, true);
				}
				...
				{
					list[1].drawInMenu(b, new Vector2((float)(this.xPositionOnScreen + 9 + (int)((float)this.width * 4.5f / 8f)), (float)(this.yPositionOnScreen + 25 + this.height / this.count * j)), 0.95f, 1f, 5f, StackDrawType.Hide, Color.White, true);
				}
				...
				{
					list[2].drawInMenu(b, new Vector2((float)(this.xPositionOnScreen + 9 + (int)((float)this.width * 5.5f / 8f)), (float)(this.yPositionOnScreen + 29 + this.height / this.count * j)), 0.9f, 1f, 5f, StackDrawType.Hide, Color.White, true);
				}
		...
		// Token: 0x0600040E RID: 1038 RVA: 0x00014E38 File Offset: 0x00013038
