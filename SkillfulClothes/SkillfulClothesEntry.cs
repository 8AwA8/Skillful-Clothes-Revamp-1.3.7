...
namespace SkillfulClothes
{
	...
	{
		// Token: 0x0600006C RID: 108 RVA: 0x00006420 File Offset: 0x00004620
		...
		// Token: 0x0600006D RID: 109 RVA: 0x00006598 File Offset: 0x00004798
		...
		// Token: 0x06000070 RID: 112 RVA: 0x0000243A File Offset: 0x0000063A
		private void GameLoop_DayEnding(object sender, DayEndingEventArgs e)
		{
			this.clothingObserver.Suspend(Game1.player, EffectChangeReason.DayEnd);
		}

		// Token: 0x06000072 RID: 114 RVA: 0x0000244D File Offset: 0x0000064D
		private void On_LocaleChanged(object sender, LocaleChangedEventArgs eventArgs)
		{
			TranslationPatches.Apply(this.helper, base.Monitor);
		}

		// Token: 0x06000073 RID: 115 RVA: 0x00002460 File Offset: 0x00000660
		...
		// Token: 0x06000074 RID: 116 RVA: 0x00006C50 File Offset: 0x00004E50
		...
		// Token: 0x06000075 RID: 117 RVA: 0x00006CA0 File Offset: 0x00004EA0
		private bool ReturnHome(GameLocation location, string[] args, Farmer player, Point point)
		{
			...
			if (list.Count == 0 || Game1.dayOfMonth % 7 == 0)
			{
				list.Clear();
				for (int j = 0; j < 3; j++)
				{
			...
			{
				Item item2 = ItemRegistry.Create(itemId, 1, 0, false);
				forSale.Add(item2);
				itemPriceAndStock.Add(item2, new ItemStockInformation(3000, int.MaxValue, null, null, LimitedStockMode.Global, null, null, null, null));
			}
			shopMenu.itemPriceAndStock = itemPriceAndStock;
			return true;
		}

		// Token: 0x06000076 RID: 118 RVA: 0x00006E88 File Offset: 0x00005088
